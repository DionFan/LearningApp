...
public class Histres3 extends AppCompatActivity implements View.OnClickListener
{
    TextView TvGrades;
    TextView TvWrongQue;
    TextView TvWrongAns;
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.histres3);
    ...
    public void onClick(View v)
    {
        System.out.println("Κεφάλαιο 1***"+ Grades1);
        System.out.println("Κεφάλαιο 2***"+ Grades2);
        System.out.println("Κεφάλαιο 3***"+ grades);
        Intent intent = new Intent (getApplicationContext (), FinalResultsSection2.class);
