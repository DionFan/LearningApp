...
public class Histque3 extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        Grades1 = Gr1;
        Grades2 = Gr2;
        System.out.println("***HistQue3 Grades 1" + Grades1);
        System.out.println("***HistQue3 Grades 2" + Grades2);
        super.onCreate (savedInstanceState);
        setContentView (R.layout.hist3que);
        findView();
        ...
        AllQuests = Questionnaire.GetInstance (this, 6);
        DoNext ();
    ...
    private void startCountDownTimertask(final CircularCountDownBar countDownBar, int cd)
    {
        ...
        new CountDownTimer((cd *= 1000) + timeOffset, 1000)
        {
            ...
            {
                if (Histque3.active == false)
                {
                    System.out.println("***Δεν κάνω τίποτα");
                }
                else
                {
                    Intent intent = new Intent (getApplicationContext (), Histres3.class);
