...
public class Hist3 extends AppCompatActivity {

    ViewPager2 myViewPager2;
    com.dfan.learningapp.MyAdapterhist3 MyAdapterhist3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("***ΚΕΦΑΛΑΙΟ 3 Grades 1"+ Grades1);
        System.out.println("***ΚΕΦΑΛΑΙΟ 3 Grades 2"+ Grades2);
        intent.putExtra("Points1", Grades1);
        intent.putExtra("Points2", Grades2);
        setContentView(R.layout.hist3);
        myViewPager2 = findViewById(R.id.viewpager);
        MyAdapterhist3 = new MyAdapterhist3(this,Grades2,Grades1);
        myViewPager2.setOrientation(ViewPager2.ORIENTATION_HORIZONTAL);
        myViewPager2.setAdapter(MyAdapterhist3);
