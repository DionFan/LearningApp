...
public class Histque1 extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        setContentView (R.layout.hist1que);
        findView();
        ...
        AllQuests = Questionnaire.GetInstance (this, 4);
        DoNext ();
        ...
        new CountDownTimer((cd *= 1000) + timeOffset, 1000)
        {
            ...
            public void onFinish()
            {
                ...
                else
                {
                    ...
                    Intent intent = new Intent (getApplicationContext (), Histres1.class);
