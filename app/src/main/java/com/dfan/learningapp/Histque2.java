...
public class Histque2 extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        setContentView (R.layout.hist2que);
        findView();
        ...
        AllQuests = Questionnaire.GetInstance (this, 5);
        DoNext ();
    ...
    private void startCountDownTimertask(final CircularCountDownBar countDownBar, int cd)
    {
        ...
        new CountDownTimer((cd *= 1000) + timeOffset, 1000)
        {
            ...
            {
                if (Histque2.active == false)
                {
                    System.out.println("***Δεν κάνω τίποτα");
                }
                else
                {
                    Intent intent = new Intent (getApplicationContext (), Histres2.class);
